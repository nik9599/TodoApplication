...
const SelectTrigger = React.forwardRef(function SelectTrigger({ className = "", children, ...props }, ref) {
  ...
  return (
    <SelectPrimitive.Trigger ref={ref} className={`${baseClass} ${className}`} {...props}>
      {children}
...
const SelectScrollUpButton = React.forwardRef(function ScrollUpButton({ className = "", ...props }, ref) {
  return (
...
const SelectScrollDownButton = React.forwardRef(function ScrollDownButton({ className = "", ...props }, ref) {
  return (
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ref={ref}
        className={`${baseContent} ${position === "popper" ? popperPos : ""} ${className}`}
        position={position}
        {...props}
      >
...
const SelectItem = React.forwardRef(function SelectItem({ className = "", children, ...props }, ref) {
  ...
  return (
    <SelectPrimitive.Item ref={ref} className={`${itemBase} ${className}`} {...props}>
